...
public class TextureRenderer {
    ...
    public void drawFrame(SurfaceTexture st, boolean invert) {
        ...
        if (overlayBitmap != null) {
            overlayTextureId = loadTexture(overlayBitmap, -1, true);
            overlayBitmap = null;
        }
        ...
        if (overlayTextureId != -1) {
            ...
            GLES20.glUniform1i(mOverlayTexHandle2, 0);
            checkGlError("glUniform1i mOverlayTexHandle2");
            mTriangleVertices.position(TRIANGLE_VERTICES_DATA_POS_OFFSET);
            GLES20.glVertexAttribPointer(maPositionHandle2, 3, GLES20.GL_FLOAT, false, TRIANGLE_VERTICES_DATA_STRIDE_BYTES, mTriangleVertices);
            checkGlError("glVertexAttribPointer maPosition");
            GLES20.glEnableVertexAttribArray(maPositionHandle2);
            checkGlError("glEnableVertexAttribArray maPositionHandle");
            mTriangleVertices.position(TRIANGLE_VERTICES_DATA_UV_OFFSET);
            GLES20.glVertexAttribPointer(maTextureHandle2, 2, GLES20.GL_FLOAT, false, TRIANGLE_VERTICES_DATA_STRIDE_BYTES, mTriangleVertices);
            checkGlError("glVertexAttribPointer maTextureHandle");
    ...
    public void surfaceCreated() {
        ...
        mProgram2 = createProgram(VERTEX_SHADER2, FRAGMENT_SHADER2);
        if (mProgram == 0 || mProgram2 == 0) {
        ...
        mOverlayTexHandle2 = GLES20.glGetUniformLocation(mProgram2, "inputImageTexture");
        checkGlError("glGetUniformLocation inputImageTexture");
        if (mOverlayTexHandle2 == -1) {
